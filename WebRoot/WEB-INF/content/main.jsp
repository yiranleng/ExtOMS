...
<%--	</head>--%>
<%--	<body>--%>
<%--		<ss:authorize ifAnyGranted="RES_A">--%>
<%--		RES_A<br>--%>
<%--		</ss:authorize>--%>
<%--		<ss:authorize ifAnyGranted="RES_B">--%>
<%--		RES_B<br>--%>
<%--		</ss:authorize>--%>
<%--		<ss:authorize ifAnyGranted="RES_C">--%>
<%--		RES_C<br>--%>
<%--		</ss:authorize>--%>
<%--		<ss:authorize ifAnyGranted="RES_D">--%>
<%--		RES_D<br>--%>
<%--		</ss:authorize>--%>
<%--		--%>
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/scripts/ext/desktop/css/desktop.css" />
		<link rel="stylesheet" type="text/css" href="/scripts/ext/desktop/colorpicker/colorpicker.css" />
		<link rel="stylesheet" type="text/css" href="/scripts/ext/desktop/qo-preferences/qo-preferences.css" />
		<!--end stytles  -->
		...
		<!-- DESKTOP -->
		<script type="text/javascript" src="/scripts/ext/desktop/js/StartMenu.js"></script>
