...
//		this.addEvents("click", "mouseover", "mouseout", "itemclick");
		this.addEvents("click", "mouseover", "mouseout", "itemclick",'contextmenu');//wuxiaoxu 20120803 add 'contextmenu'
		Ext.menu.MenuMgr.register(this);
		if (this.floating) {
			Ext.EventManager.onWindowResize(this.hide, this)
		} else {
	...
	onRender : function(b, a) {
		...
		this.mon(this.ul, {
					scope : this,
					click : this.onClick,
					contextmenu :  this.onContextmenu,//wuxiaoxu add
	...
	// wuxiaoxu  20120803 for menu add Contextmenu
...
//		this.over = true;
		this.fireEvent("contextmenu", this, b, a)
		
//		var t;
//		if (t = this.findTargetItem(e)) {
//			this.fireEvent("contextmenu", this, t, e);
//		}
