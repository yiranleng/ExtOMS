...
Ext.ux.TaskBarContainer = Ext.extend(Ext.Container, {
    initComponent : function() {
        ...
        Ext.EventManager.onWindowResize(this.fireResize, this);//wuxiaoxu 20120728 当window发生改变时 触发
...
Ext.ux.TaskButtonsPanel = Ext.extend(Ext.BoxComponent, {
    activeButton: null,
//    enableScroll: true,
    enableScroll: false,//wuxiaoxu 20120801 modify 修改工具栏 出现滚动条问题
    scrollIncrement: 0,
    ...
    delegateUpdates : function(){
        ...
        //start wuxiaoxu 20100801此处影响 当开启窗口在关闭后 改变大小是的 工具条出现滚动条
        /**
         * change 
         * enableScroll：false；
         */
        ...
        //end wuxiaoxu 此处影响 当开启窗口在关闭后 改变大小是的 工具条出现滚动条
    },
...
//            alert(typeof(w.maximizable));//wuxiaoxu test
            
            items[0].setDisabled(w.maximized !== true && w.hidden !== true);
            items[1].setDisabled(w.minimized === true);
            items[2].setDisabled(w.maximized === true || w.hidden === true);
            
            //wuxiaoxu 20120811 add make it read onley while do not have maximizable
            items[2].setDisabled(w.maximizable === false|| w.hidden === true);
        }, this);
